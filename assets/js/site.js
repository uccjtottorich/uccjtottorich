document.addEventListener("DOMContentLoaded", () => {
  ...
  if (filterPanel) {
    const descriptions = {
      ...
      bible_study: "聖書の豊かなみことばをじっくりと学び、共に分かち合い、静かに祈りを捧げる平日の「聖書研究・祈祷会」や「聖書に親しむ集い」をお勧めします。",
      ...
      weekday: "平日の落ち着いた時間帯に集まりたいご婦人の方向けに、親睦と学びを兼ねた女性の会「シオン会」や、毎週木曜日の「聖書研究・祈祷会」がございます。",
